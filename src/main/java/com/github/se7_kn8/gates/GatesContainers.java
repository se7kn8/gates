...
public class GatesContainers {
	...
	public static final ContainerType<FrequencyContainer> FREQUENCY_CONTAINER_TYPE = addContainerType("transmitter", IForgeContainerType.create((windowId, inv, data) -> new FrequencyContainer(windowId, inv.player.level, data.readBlockPos(), inv, inv.player)));
	...
	public static final ContainerType<AdvancedRedstoneClockContainer> ADVANCED_REDSTONE_CLOCK_CONTAINER_TYPE = addContainerType("advanced_redstone_clock", IForgeContainerType.create((windowId, inv, data) -> new AdvancedRedstoneClockContainer(windowId, inv.player.level, data.readBlockPos(), inv, inv.player)));
